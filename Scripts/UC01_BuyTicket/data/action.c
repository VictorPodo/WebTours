Action()
{
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=userSession", "Value=131363.522154719zHfHAVVpVHAiDDDDtAftcpAzHAcf", ENDITEM, 
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value=020;491;05/23/2021", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Business", ENDITEM, 
		"Name=seatPref", "Value=Window", ENDITEM, 
	...
	web_submit_data("reservations.pl_3", 
		...
		"Name=address1", "Value=Kirsin Len", ENDITEM, 
		"Name=address2", "Value=USA", ENDITEM, 
		"Name=pass1", "Value=Jojo Bean", ENDITEM, 
		"Name=creditCard", "Value=12312323213133", ENDITEM, 
		"Name=expDate", "Value=1225", ENDITEM, 
